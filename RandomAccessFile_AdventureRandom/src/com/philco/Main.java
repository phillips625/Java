                    // LEARNING TO USE THE JAVA.IO PACKAGE!
...
// Both of these reduces the disk access time by reading and writing large chucks of data.
...
//            tempExit.remove("S");
            ...
            if (exits.containsKey(direction)){
                ...
                // We're updating our current location by moving to whatever direction that was selected by the user.
                // Consequently, the while loop will print the new description, etc of the new room.
        ...
        // 'close' method closes the random file when the player has exited the game.
        locations.close();
    }
}
